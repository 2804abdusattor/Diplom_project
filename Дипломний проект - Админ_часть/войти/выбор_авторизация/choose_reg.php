...
<head>
	...
	<link rel="stylesheet"  href="/Дипломний проект - Админ_часть/войти/style_authorization.css" type="text/css">
	<link rel="stylesheet"  href="/English_club_folder/css/font-awesome.css" type="text/css">
	<title>Форма регистрации</title>
</head>
<body style="background-color:gray;">
	<div class="col">
		<form action="/Дипломний проект - Админ_часть/войти/registr.php" method="post">

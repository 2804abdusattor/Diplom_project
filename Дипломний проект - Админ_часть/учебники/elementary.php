...
.ELEMENTARY_block a:hover {
    color: red;
}
.ELEMENTARY_block #next,.ELEMENTARY_block #main{
	color: black;
	margin: 5px;
	padding: 5px;
	color: darkred;
...
.ELEMENTARY_block #next:hover,.ELEMENTARY_block #main:hover {
	color: green;
}
...
<body>
	<div class="ELEMENTARY_block">
		<h1>Уроки по Elementary(Элеметарный)</h1>
		...
		<p><a href="">Урок 7. Apostrophe(апостроф)</a></p><br>
		<a id ="main" href="/Дипломний проект - Админ_часть/index.php">Главная страница</a><a id ="next" href="/Дипломний проект - Админ_часть/учебники/pre-intermidiate.php">Далее</a><br>
	</div>

...
.Intermediate_block a {
    text-decoration: none;
    color: black;
    font-size: 1.3em;
}

.Intermediate_block a:hover {
    color: red;
}
.Intermediate_block #next,.Intermediate_block #main{
	color: black;
	margin: 5px;
	padding: 5px;
	color: darkred;
...
.Intermediate_block #next:hover,.Intermediate_block #main:hover {
	color: green;
}
...
<body>
	<div class="Intermediate_block">
		<h1 >Уроки по Intermediate(Средный)</h1>
		...
		<p><a href="">Урок 7. Apostrophe(апостроф)</a></p><br><a id ="main" href="/Дипломний проект - Админ_часть/index.php">Главная страница</a>
		<a id ="next" href="/Дипломний проект - Админ_часть/учебники/upper-intermidiate.php">Далее</a><br>
	</div>
